...
| 4 — Assessment Prep | [`burp-course-assessment.html`](burp-course-assessment.html) | 17–20 | BSCP exam blueprint, objective-to-module mapping, two timed mock exams, 25 timed drills, revision checklist, consolidated flashcards, full interview question bank, readiness self-assessment, exam-day strategy |
...
- **Real practice links** — labs and the certification track point to the actual [PortSwigger Web Security Academy](https://portswigger.net/web-security) topics and the official [BSCP certification](https://portswigger.net/web-security/certification) pages.
- **Practical throughout** — real HTTP request/response examples, payload tables, worked Burp workflows, three full sample vulnerability findings (with CWE/OWASP mapping, reproduction steps, evidence, business impact, and remediation), knowledge checks, flashcards, and interview questions in every module.
